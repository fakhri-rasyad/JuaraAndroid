...
fun GreetingText(message: String, from: String, modifier: Modifier = Modifier) {
    Column(verticalArrangement = Arrangement.Center, modifier = modifier) {
        ...
        Text(
            text = message,fontSize = 100.sp, lineHeight = 116.sp, textAlign = TextAlign.Center, modifier = Modifier.padding(8.dp)
        )
...
fun BirthdayCardPreview() {
    HappyBirthdayTheme {
        GreetingImage(message = "Happy Birthday Me!", from="Me")
    }
}
